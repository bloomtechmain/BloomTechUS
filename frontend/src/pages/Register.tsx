      ...
      >
        <div className="p-10 md:p-12">
          <div className="flex flex-col items-center mb-10 text-center">
             ...
             <h2 className="text-3xl font-black text-[#0c1a36] tracking-tighter">Create Hub</h2>
             <p className="text-gray-500 font-medium text-sm mt-2">Join the next-gen identity network</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {loading ? 'Creating Hub...' : 'Create My Account'}
            </button>
          </form>
          ...
          <div className="mt-10 pt-10 border-t border-gray-50 text-center">
            <p className="text-gray-500 text-sm font-semibold">
              Already have an account? <Link to="/login" className="text-[#ff6b00] font-black hover:underline ml-1">Sign In</Link>
            </p>
          </div>
        </div>
      </motion.div>
